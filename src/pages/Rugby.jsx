        ...
        <div className="container rugby-overview__grid">
          <div className="rugby-feature">
            <div className="rugby-feature__content">
              <img
                src="/header-logo.png"
                alt="Jaffna Bulls Rugby"
                className="rugby-feature__logo"
              />
              ...
              {/* <p>
                The home of Jaffna Bulls rugby — explore the squad, coaching
                staff, fixtures, announcements, and match updates.
              </p> */}
            </div>
          </div>
